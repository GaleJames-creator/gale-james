# Understanding payment authorization failures

Boost successful payment authorizations and avoid authorization failures with these practical tips.

See [When not to retry](#when-not-to-retry) for more information.
...
If retries always happen on the same day of the week, they might consistently hit:

* Weekly spending limits
* Payday timing issues (the customer has no money every Friday)
* Recurring maintenance windows

This approach can increase your authorization success rate.
...
```json
"We couldn’t process your payment. Try another payment method or ask your bank for help."
```

### Metrics to track

Optimize your retry strategy by tracking: Retry success rate, decline code types, average retries per success, revenue recovered, and churn by decline type.

## Next steps

### Explanation

* [Understanding authorization and capture](../explanation/understanding-authorization-capture.md): Learn more about authorization and capture.
