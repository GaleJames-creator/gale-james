...
Webhooks let your apps get real-time updates from other services when events happen. You can use them to update apps, send notifications, or sync data. 

## Key concepts

The webhook service notifies your endpoint URL of API events via webhooks, each carrying the event type and timestamp. 
