...
4. Monitor [rate limits](./payment-api-rate-limits.md). Too many requests trigger a `429` error.  
...
7. Contact support if the same error recurs, or create a support case; some systems automatically report repeated errors.
