...
**Note**: This company repository showcases my experience with docs-as-code workflows, Git version control, and GitBook. I cannot fork or duplicate proprietary content due to confidentiality.

My contributions included: 

- Developed API reference documentation for the Commerce APIs 
- Wrote integration guides for electronic funds transfer systems for the Digital River and Commerce APIs 
- Led migration from Drupal to ReadMe to GitBook 
...
## Portfolio
[Full portfolio and writing samples]([https://drive.google.com/drive/folders/1MlwuZhE9Z25Mc-UtfOaHz_Ynq6_uSzVH](https://github.com/GaleJames-creator/gale-james)
