...
This guide assumes you received a webhook containg an anonymous shopper's user ID (`userId). To retrieve an anonymous shopper's orders and product information by using their `userId`, follow these steps:
